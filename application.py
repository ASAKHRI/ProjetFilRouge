...
with col2:    
    ...
    selected_age = st.number_input("Age client", min_value=18, max_value=90,  step=1)
    # Affichage de la valeur saisie
    st.write("Age", selected_age)


    st.subheader('Ancienneté proessionnelle')
    # Utilisation du widget st.number_input()
    selected_ancienneté_professionnelle = st.number_input("Anciennet&é professionnelle", min_value=0, max_value=50,  step=1)
    # Affichage de la valeur saisie
    st.write("Ancienneté professionnelle", selected_ancienneté_professionnelle)
    
    st.subheader('Montant bien voulu')
    # Utilisation du widget st.number_input()
    montant_bien = st.number_input("Saisissez une valeur numérique", min_value=1000.0, max_value=100000000.0, step=500.0)
    # Affichage de la valeur saisie
